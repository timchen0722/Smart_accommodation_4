...
ui_kit.page_header(
    "Airbnb 平台營運後台", icon="📊",
    desc="平台方視角:先看市場總覽掌握全局，再進風險管理處理個案，"
         "營收與成長找機會，數據分析查模型可信度")
...
.st-key-pf_tabbar [data-testid="stButtonGroup"] [role="radiogroup"]{
  gap:0 !important; border-bottom:2px solid var(--sa-border); flex-wrap:nowrap;}
