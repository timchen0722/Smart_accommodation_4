...
- [ ] **Step 3: 在 notify_center.py 檔尾新增(不動現有函式)**
...
- [ ] **Step 1: 在 risk_cockpit_sections.py 新增導覽 callback、麵包屑、render 入口、房東檢視**
...
- [ ] **Step 2: 改 platform_sections.py — render_risk_management 委派、移除舊聚焦**
...
- [ ] **Step 3: 改寫 AppTest — 房東檢視斷言(移除 FOCUS_ALL 依賴)**
...
- [ ] **Step 1: 取代 `_render_listings` 佔位並新增房源列/LIME/單筆函式**
...
- [ ] **Step 2: 在 `_render_listings` 接上「全選目前篩選結果」與浮動列**
